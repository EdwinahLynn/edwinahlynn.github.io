...
import { deletePost, fetchEvent, fetchPost, fetchUser, fetchUsers, updateEvent, updatePosts } from "./api/index.js";
import { createEvents, createPosts, createUsers, deleteEvent, deleteUserInfo, fetchEvents, fetchPosts, updateUserInfo } from "./api/index.js";
...
(function () {
    ...
    async function DisplayCommunityPostsPage() {
        ...
        document.querySelectorAll("button.updatePost").forEach((button) => {
            button.addEventListener("click", async function (event) {
                ...
                let titlePostPage = document.getElementById("postTitleUpdate");
                let descriptionPostPage = document.getElementById("postDesUpdate");
                titlePostPage.value = posts.postTitle;
                descriptionPostPage.value = posts.postDescription;
                const updatePostButton = document.getElementById("postUpdate");
                const cancelPostButton = document.getElementById("cancelPostUpdate");
                if (!updatePostButton) {
                ...
                updatePostButton.addEventListener("click", async function (event) {
                    ...
                    event.preventDefault();
                    let postTitle = document.getElementById("postTitleUpdate").value.trim();
                    let postDescription = document.getElementById("postDesUpdate").value.trim();
    ...
    function DisplayNewPostPage() {
        ...
        newPostButton.addEventListener("click", async (event) => {
            ...
            const postDescription = document.getElementById("postDes").value.trim();
    ...
    function DisplayNewAccountPage() {
        ...
        createButton.addEventListener("click", async (event) => {
            event.preventDefault();
            const displayName = document.getElementById("DisplayNameNew").value.trim();
            const emailAddress = document.getElementById("emailAddressNew").value.trim();
    ...
    async function DisplayViewAccountPage() {
        ...
        if (userSession) {
            ...
            console.log(users);
            const pageName = document.getElementById("displayNameView");
            const pageEmail = document.getElementById("emailAddressView");
            const pageUserName = document.getElementById("userNameView");
            const pagePassword = document.getElementById("passwordView");
            let id = null;
    ...
    async function DisplayEditEventPage(id = "") {
        ...
        let description = document.getElementById("uDescription");
        let location = document.getElementById("uLocation");
        let time = document.getElementById("uTime");
        ...
        const submitButton = document.getElementById("submitUpdatedEvent");
        const cancelButton = document.getElementById("cancelUpdateEvent");
        submitButton.addEventListener("click", async (event) => {
            event.preventDefault();
            let eventName = document.getElementById("uName").value;
            let eventDate = document.getElementById("uDate").value;
            let eventDescription = document.getElementById("uDescription").value;
            let eventLocation = document.getElementById("uLocation").value;
            let eventTime = document.getElementById("uTime").value;
    ...
    async function DisplayEventPlanningPage() {
        ...
        submitEventButton.addEventListener("click", async (event) => {
            ...
            let eventName = document.getElementById("eName").value.trim();
            let eventDate = document.getElementById("eDate").value.trim();
            let eventDescription = document.getElementById("eDescription").value.trim();
            let eventLocation = document.getElementById("eLocation").value.trim();
            let eventTime = document.getElementById("eTime").value.trim();
    ...
    async function DisplayLoginPage() {
        ...
        let newUserAccount = document.getElementById("account");
        if (!newUserAccount) {
            return;
        }
